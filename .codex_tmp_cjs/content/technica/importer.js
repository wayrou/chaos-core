...
exports.validateTechnicaManifest = validateTechnicaManifest;
exports.importTechnicaRuntimeEntry = importTechnicaRuntimeEntry;
exports.importTechnicaEntry = importTechnicaEntry;
const gameStore_1 = require("../../state/gameStore");
const index_1 = require("./index");
const codexSystem_1 = require("../../core/codexSystem");
const mailSystem_1 = require("../../core/mailSystem");
...
function validateTechnicaManifest(manifest) {
...
function syncPublishedTechnicaGameState() {
    if (!(0, gameStore_1.hasGameState)()) {
        return;
    }
    (0, gameStore_1.updateGameState)((prev) => (0, stateSync_1.syncPublishedTechnicaContentState)(prev, (0, index_1.getTechnicaRegistryFingerprint)()));
}
function importTechnicaRuntimeEntry(contentType, entryData, options) {
    switch (contentType) {
        case "map":
            if (!isFieldMap(entryData)) {
                throw new Error("Entry data does not match the expected Chaos Core field map shape.");
            }
            (0, index_1.registerImportedFieldMap)(entryData);
        ...
        case "quest":
            ...
            (0, index_1.registerImportedQuest)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "key_item": {
            ...
            (0, index_1.registerImportedKeyItem)(resolvedItem);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
        ...
        case "faction":
            ...
            (0, index_1.registerImportedFaction)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "chassis":
            ...
            (0, index_1.registerImportedChassis)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "doctrine":
            ...
            (0, index_1.registerImportedDoctrine)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "dialogue":
            ...
            (0, index_1.registerImportedDialogue)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "mail":
            ...
            (0, index_1.registerImportedMailEntry)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
                (0, mailSystem_1.syncImportedMailUnlocks)();
            }
            return entryData.id;
        case "chatter":
            ...
            (0, index_1.registerImportedChatterEntry)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "field_enemy": {
            ...
            (0, index_1.registerImportedFieldEnemyDefinition)(resolvedDefinition);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
        ...
        case "item": {
            ...
            (0, index_1.registerImportedItem)(resolvedItem);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return resolvedItem.id;
        ...
        case "npc": {
            ...
            (0, index_1.registerImportedNpc)(resolvedNpc);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
        ...
        case "gear": {
            ...
            (0, index_1.registerImportedGear)(resolvedGear);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
        ...
        case "card": {
            ...
            (0, index_1.registerImportedCard)(resolvedCard);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
        ...
        case "fieldmod":
            ...
            (0, index_1.registerImportedFieldMod)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "class":
            ...
            (0, index_1.registerImportedClass)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "unit":
            ...
            (0, index_1.registerImportedUnit)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "operation":
            ...
            (0, index_1.registerImportedOperation)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
            }
            return entryData.id;
        case "codex":
            ...
            (0, index_1.registerImportedCodexEntry)(entryData);
            if (options?.syncToGameState) {
                syncPublishedTechnicaGameState();
                (0, codexSystem_1.syncImportedCodexUnlocks)();
            }
            return entryData.id;
        default:
...
function importTechnicaEntry(manifest, entryData, options) {
