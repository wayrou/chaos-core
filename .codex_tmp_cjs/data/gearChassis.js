...
exports.ALL_CHASSIS = [
    // WEAPON CHASSIS
    {
        ...
        buildCost: (0, resources_1.createEmptyResourceWallet)({
            metalScrap: 15,
            wood: 5,
            chaosShards: 0,
            steamComponents: 2,
...
function getChassisById(id) {
    return exports.ALL_CHASSIS.find(c => c.id === id);
}
function getChassisBySlotType(slotType) {
    return exports.ALL_CHASSIS.filter(c => c.slotType === slotType);
}
function getAllChassisIds() {
    return exports.ALL_CHASSIS.map(c => c.id);
}
