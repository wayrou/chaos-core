...
exports.EQUIPMENT_CARDS = void 0;
function sanitizeEquipmentCard(card) {
    const description = card.description.trim();
    const lowerName = card.name.toLowerCase();
    const lowerDescription = description.toLowerCase();
    const isPlaceholder = lowerDescription.startsWith("use ") ||
        lowerDescription === "ranged attack." ||
        lowerDescription === "defensive action or stance.";
    if (!isPlaceholder) {
        return card;
    }
    const isSelfCard = (card.range || "").toLowerCase().includes("self") ||
        ["guard", "stance", "brace", "ward", "shield", "veil", "focus", "resolve", "dodge", "form", "barrier"].some(hint => lowerName.includes(hint));
...
exports.EQUIPMENT_CARDS = RAW_EQUIPMENT_CARDS.map(sanitizeEquipmentCard);
