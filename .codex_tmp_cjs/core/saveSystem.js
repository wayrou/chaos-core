...
exports.SHARED_CAMPAIGN_SLOTS = exports.SAVE_SLOTS = void 0;
exports.isSharedCampaignSlot = isSharedCampaignSlot;
exports.saveGame = saveGame;
exports.saveSharedCampaign = saveSharedCampaign;
exports.loadGame = loadGame;
exports.loadSharedCampaign = loadSharedCampaign;
exports.hasSave = hasSave;
exports.hasSharedCampaignSave = hasSharedCampaignSave;
exports.deleteSave = deleteSave;
exports.listSaves = listSaves;
exports.listSharedCampaignSaves = listSharedCampaignSaves;
exports.canContinue = canContinue;
exports.loadMostRecent = loadMostRecent;
exports.enableAutosave = enableAutosave;
exports.disableAutosave = disableAutosave;
exports.triggerAutosave = triggerAutosave;
exports.setAutosaveEnabled = setAutosaveEnabled;
exports.isAutosaveEnabled = isAutosaveEnabled;
exports.enableSharedCampaignAutosave = enableSharedCampaignAutosave;
exports.disableSharedCampaignAutosave = disableSharedCampaignAutosave;
exports.triggerSharedCampaignAutosave = triggerSharedCampaignAutosave;
exports.formatSaveTimestamp = formatSaveTimestamp;
exports.getSaveSlotName = getSaveSlotName;
exports.getSharedCampaignSlotName = getSharedCampaignSlotName;
...
exports.SHARED_CAMPAIGN_SLOTS = {
    CAMPAIGN_1: "coop_campaign_1",
    CAMPAIGN_2: "coop_campaign_2",
    CAMPAIGN_3: "coop_campaign_3",
};
const KNOWN_PERSISTED_SLOTS = [
    ...Object.values(exports.SAVE_SLOTS),
    ...Object.values(exports.SHARED_CAMPAIGN_SLOTS),
];
function isPrimarySaveSlot(slot) {
    return Object.values(exports.SAVE_SLOTS).includes(slot);
}
function isSharedCampaignSlot(slot) {
    return Object.values(exports.SHARED_CAMPAIGN_SLOTS).includes(slot);
}
...
function buildPersistedState(slot, state, timestamp, sharedCampaignMetadata) {
    return {
        ...
        _campaignProgressSnapshot: (0, campaign_1.loadCampaignProgress)(),
 ...
 */
async function saveGame(slot, state) {
    return savePersistedSlot(slot, state);
}
async function saveSharedCampaign(slot, state, options = {}) {
...
async function loadSharedCampaign(slot) {
...
async function loadPersistedSlot(slot) {
    try {
        ...
        const campaignProgress = persistedState._campaignProgressSnapshot ?? (0, campaign_1.createDefaultCampaignProgress)();
        ...
        const state = (0, theaterDeploymentPreset_1.withNormalizedTheaterDeploymentPresetState)({
            ...persistedState,
...
async function hasSharedCampaignSave(slot) {
    try {
        if (isTauriAvailable()) {
            return await tauriHasSave(slot);
        }
...
async function listSharedCampaignSaves() {
...
async function loadMostRecent() {
    ...
    const autosave = saves.find(s => s.slot === exports.SAVE_SLOTS.AUTOSAVE);
    if (autosave) {
        return await loadGame(exports.SAVE_SLOTS.AUTOSAVE);
    }
 ...
 */
function enableAutosave(getState) {
    ...
    autosaveTimer = window.setInterval(async () => {
        if (autosaveEnabled && autosaveStateGetter) {
            ...
            if (state.phase !== "battle") {
                await saveGame(exports.SAVE_SLOTS.AUTOSAVE, state);
            }
        }
    }, AUTOSAVE_INTERVAL);
 ...
 */
async function triggerAutosave(state) {
    if (!autosaveEnabled) {
        return { success: false, error: "Autosave is disabled" };
    }
    return await saveGame(exports.SAVE_SLOTS.AUTOSAVE, state);
}
/**
...
function enableSharedCampaignAutosave(getState, getSlot, onSaved) {
...
function disableSharedCampaignAutosave() {
    if (sharedCampaignAutosaveTimer !== null) {
        clearInterval(sharedCampaignAutosaveTimer);
...
async function triggerSharedCampaignAutosave(state) {
 ...
 */
function getSaveSlotName(slot) {
    switch (slot) {
        case exports.SAVE_SLOTS.AUTOSAVE:
            return "Autosave";
        case exports.SAVE_SLOTS.MANUAL_1:
            return "Save Slot 1";
        case exports.SAVE_SLOTS.MANUAL_2:
            return "Save Slot 2";
        case exports.SAVE_SLOTS.MANUAL_3:
            return "Save Slot 3";
        default:
            return slot;
    }
}
function getSharedCampaignSlotName(slot) {
    switch (slot) {
        case exports.SHARED_CAMPAIGN_SLOTS.CAMPAIGN_1:
            return "Shared Campaign 1";
        case exports.SHARED_CAMPAIGN_SLOTS.CAMPAIGN_2:
            return "Shared Campaign 2";
        case exports.SHARED_CAMPAIGN_SLOTS.CAMPAIGN_3:
