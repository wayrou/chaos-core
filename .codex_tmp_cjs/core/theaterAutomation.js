...
exports.createEmptyTheaterAutomationState = createEmptyTheaterAutomationState;
exports.normalizeTheaterAutomationState = normalizeTheaterAutomationState;
exports.normalizeTheaterAnnexes = normalizeTheaterAnnexes;
exports.normalizeTheaterPartitions = normalizeTheaterPartitions;
exports.getTheaterEdgeId = getTheaterEdgeId;
exports.getTheaterSelectedNodeId = getTheaterSelectedNodeId;
exports.getTheaterCurrentNodeId = getTheaterCurrentNodeId;
exports.getAnnexChildIds = getAnnexChildIds;
exports.getTheaterRootRoomIdForNode = getTheaterRootRoomIdForNode;
exports.getTheaterRootRoomForNode = getTheaterRootRoomForNode;
exports.resolveTheaterNode = resolveTheaterNode;
exports.isTheaterNodeVisible = isTheaterNodeVisible;
exports.isTheaterNodeSecured = isTheaterNodeSecured;
exports.getTheaterNodeAdjacency = getTheaterNodeAdjacency;
exports.isBlastDoorClosed = isBlastDoorClosed;
exports.canTraverseTheaterEdge = canTraverseTheaterEdge;
exports.getTheaterNodeMoveTickCost = getTheaterNodeMoveTickCost;
exports.findTheaterNodeRoute = findTheaterNodeRoute;
exports.canAutomationReachTarget = canAutomationReachTarget;
exports.applyAnnexInheritedNetwork = applyAnnexInheritedNetwork;
exports.getAutomatedTurretCountForRoom = getAutomatedTurretCountForRoom;
exports.evaluateTheaterAutomation = evaluateTheaterAutomation;
...
function createEmptyTheaterAutomationState() {
    return {
        moduleInstancesById: {},
        moduleRuntimeById: {},
...
function normalizeTheaterAutomationState(automation) {
    return {
...
function normalizeTheaterAnnexes(annexes) {
...
function normalizeTheaterPartitions(partitions) {
...
function isTheaterNodeVisible(theater, nodeId) {
...
function isTheaterNodeSecured(theater, nodeId) {
    const resolved = resolveTheaterNode(theater, nodeId);
    if (!resolved) {
        return false;
    }
...
function getTheaterNodeAdjacency(theater, nodeId) {
    const room = theater.rooms[nodeId];
    if (room) {
...
function isBlastDoorClosed(theater, nodeAId, nodeBId) {
...
function canTraverseTheaterEdge(theater, fromNodeId, toNodeId) {
...
function getTheaterNodeMoveTickCost(theater, nodeId) {
    const room = theater.rooms[nodeId];
    if (!room) {
        return 1;
    }
...
function findTheaterNodeRoute(theater, fromNodeId, toNodeId, options) {
...
function canAutomationReachTarget(theater, sourceNodeId, targetNodeId, requiredBw) {
...
function applyAnnexInheritedNetwork(theater) {
...
function getAutomatedTurretCountForRoom(theater, roomId) {
...
function evaluateTheaterAutomation(theater) {
