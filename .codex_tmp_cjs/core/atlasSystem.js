...
exports.getAtlasFloorMaps = getAtlasFloorMaps;
exports.getAtlasTheaterSummary = getAtlasTheaterSummary;
exports.getAtlasTheaterByOperationId = getAtlasTheaterByOperationId;
exports.createAtlasOperation = createAtlasOperation;
...
function cloneFloorMap(floor) {
    return {
        ...floor,
        theaters: floor.theaters.map(cloneTheaterSummary),
    };
}
function getAtlasFloorMaps() {
...
function createAtlasOperation(theaterId) {
