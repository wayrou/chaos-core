...
exports.FIELD_MOD_DEFINITIONS = void 0;
exports.getAllFieldModDefs = getAllFieldModDefs;
exports.getFieldModDef = getFieldModDef;
const fieldModStrings_1 = require("./fieldModStrings");
const technica_1 = require("../content/technica");
exports.FIELD_MOD_DEFINITIONS = {
    // ============================================================================
    // COMMON - Unit Scope
    // ============================================================================
    mod_contact_damage: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("hit")}: 15% chance to deal +1 damage to a random enemy.`,
        rarity: "common",
        scope: "unit",
        trigger: "hit",
    ...
    mod_kill_draw: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("kill")}: Draw 1 card.`,
        rarity: "common",
        scope: "unit",
        trigger: "kill",
    ...
    mod_initiative_shield: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("turn_start")}: Gain 2 shield.`,
        rarity: "common",
        scope: "unit",
        trigger: "turn_start",
    ...
    mod_command_cost_reduction: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("card_played")}: 20% chance to reduce cost of next card by 1.`,
        rarity: "common",
        scope: "unit",
        trigger: "card_played",
    ...
    mod_area_secured_shard: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("room_cleared")}: Gain 1 chaos shard.`,
        rarity: "common",
        scope: "unit",
    ...
    mod_engagement_shield: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("battle_start")}: Gain 3 shield.`,
        rarity: "common",
        scope: "unit",
    ...
    mod_contact_bleed: {
        ...
        name: "Serrated Edge",
        description: `${(0, fieldModStrings_1.getTriggerLabel)("hit")}: 25% chance to apply 1 bleed stack to hit target.`,
        rarity: "uncommon",
        scope: "unit",
        trigger: "hit",
    ...
    mod_kill_shield_team: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("kill")}: 30% chance all allies gain 2 shield.`,
        rarity: "uncommon",
        scope: "unit",
        trigger: "kill",
    ...
    mod_precision_burn: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("crit")}: Apply 2 burn stacks to hit target.`,
        rarity: "uncommon",
        scope: "unit",
        trigger: "crit",
    ...
    mod_resupply_team: {
        ...
        name: "Team Resupply",
        description: `${(0, fieldModStrings_1.getTriggerLabel)("draw")}: All allies draw 1 card.`,
        rarity: "uncommon",
        scope: "unit",
        trigger: "draw",
    ...
    mod_squad_engagement_drone: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("battle_start")}: Deploy 1 combat drone.`,
        rarity: "rare",
        scope: "squad",
        trigger: "battle_start",
    ...
    mod_squad_kill_shield: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("kill")}: 25% chance all allies gain 3 shield.`,
        rarity: "rare",
        scope: "squad",
        trigger: "kill",
    ...
    mod_squad_contact_damage: {
        ...
        description: `${(0, fieldModStrings_1.getTriggerLabel)("hit")}: 20% chance to deal 2 damage to all enemies.`,
        rarity: "rare",
        scope: "squad",
        trigger: "hit",
...
function getAllFieldModDefs() {
    const imported = (0, technica_1.getAllImportedFieldMods)().map((fieldMod) => ({
        id: fieldMod.id,
        name: fieldMod.name,
    ...
    const merged = new Map(Object.values(exports.FIELD_MOD_DEFINITIONS).map((entry) => [entry.id, entry]));
    imported.forEach((entry) => merged.set(entry.id, entry));
    return Array.from(merged.values());
}
function getFieldModDef(id) {
