...
exports.getClassDefinition = getClassDefinition;
exports.getAvailableClasses = getAvailableClasses;
exports.isClassUnlocked = isClassUnlocked;
exports.getUnlockableClasses = getUnlockableClasses;
exports.getClassTier = getClassTier;
exports.getClassRankLetter = getClassRankLetter;
exports.getClassesByTier = getClassesByTier;
exports.getUnlockRequirementsText = getUnlockRequirementsText;
exports.getClassAbilityGrid = getClassAbilityGrid;
exports.getUnlockedClassGridNodes = getUnlockedClassGridNodes;
exports.isClassGridNodeUnlocked = isClassGridNodeUnlocked;
exports.getClassRankFromGridNodeCount = getClassRankFromGridNodeCount;
exports.getDisplayedClassRank = getDisplayedClassRank;
exports.syncClassRanksWithGrid = syncClassRanksWithGrid;
exports.canUnlockClassGridNode = canUnlockClassGridNode;
exports.purchaseClassGridNode = purchaseClassGridNode;
exports.unlockEligibleClasses = unlockEligibleClasses;
exports.createDefaultClassProgress = createDefaultClassProgress;
exports.changeUnitClass = changeUnitClass;
exports.addClassXP = addClassXP;
exports.addMilestone = addMilestone;
const technica_1 = require("../content/technica");
const questManager_1 = require("../quests/questManager");
// ============================================================================
// CLASS DEFINITIONS
// ============================================================================
...
function getClassCatalog() {
    const catalog = {};
    Object.entries(exports.CLASS_DEFINITIONS).forEach(([classId, classDefinition]) => {
        if (!(0, technica_1.isTechnicaContentDisabled)("class", classId)) {
            catalog[classId] = classDefinition;
        }
    });
    (0, technica_1.getAllImportedClasses)().forEach((classDefinition) => {
...
function getClassDefinition(classId) {
    return getClassCatalog()[classId] || exports.CLASS_DEFINITIONS.squire;
}
function getAvailableClasses() {
    return Object.keys(getClassCatalog());
}
function isClassUnlocked(classId, progress) {
    ...
    return conditions.every(condition => {
        switch (condition.type) {
            ...
            case "quest_completed":
                ...
                return (0, questManager_1.isQuestCompleted)(condition.requiredQuestId);
            case "milestone":
            case "special":
...
function getUnlockableClasses(progress) {
...
function getClassRankLetter(rank) {
    if (rank >= 5)
        return "A";
    if (rank >= 4)
        return "B";
...
function getClassAbilityGrid(classId) {
    const classDef = getClassDefinition(classId);
...
function getUnlockedClassGridNodes(progress, classId) {
    return [...(progress.gridUnlocks?.[classId] || [])];
}
function isClassGridNodeUnlocked(progress, classId, nodeId) {
    return getUnlockedClassGridNodes(progress, classId).includes(nodeId);
}
function getClassRankFromGridNodeCount(nodeCount) {
    if (nodeCount >= 5)
        return 5;
    if (nodeCount >= 4)
        return 4;
...
function getDisplayedClassRank(progress, classId) {
...
function syncClassRanksWithGrid(progress) {
...
function canUnlockClassGridNode(progress, classId, nodeId) {
...
function purchaseClassGridNode(progress, classId, nodeId) {
...
function unlockEligibleClasses(progress) {
...
function createDefaultClassProgress(unitId) {
    return {
        unitId,
        classRanks: {
            squire: 1,
...
function changeUnitClass(progress, newClass) {
    // Must be unlocked
...
function addClassXP(progress, classId, xp) {
