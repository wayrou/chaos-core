...
exports.CHASSIS_BASE_CONFIGS = exports.MATERIAL_BIASES = void 0;
exports.getDefaultChassisConfig = getDefaultChassisConfig;
exports.getChassisConfig = getChassisConfig;
/**
 * Material bias definitions
 */
exports.MATERIAL_BIASES = {
    metal_scrap: {
        doctrineTagWeights: {
            assault: 1.5,
            suppression: 1.2,
 ...
 */
function getDefaultChassisConfig() {
    return {
        baseStabilityRange: { min: 60, max: 80 },
        baseSlotLockChance: 0.1,
        maxLockedSlots: 1,
 ...
 */
function getChassisConfig(chassisId) {
    return exports.CHASSIS_BASE_CONFIGS[chassisId] || getDefaultChassisConfig();
}
