...
exports.initializeAudioSystem = initializeAudioSystem;
exports.disposeAudioSystem = disposeAudioSystem;
exports.registerMusicTrack = registerMusicTrack;
exports.setMusicCue = setMusicCue;
exports.stopMusic = stopMusic;
exports.getCurrentMusicCue = getCurrentMusicCue;
exports.playPlaceholderSfx = playPlaceholderSfx;
exports.playNamedAudioHook = playNamedAudioHook;
exports.playSystemPingSfx = playSystemPingSfx;
...
async function applyMusicCue(cue, options) {
    ...
    audio.volume = clampVolume(getEffectiveChannelVolume((0, settings_1.getSettings)().musicVolume) * (track.volume ?? 1));
...
function playTonePattern(steps) {
    ...
    if (getEffectiveChannelVolume((0, settings_1.getSettings)().sfxVolume) <= 0) {
        return;
    }
    const ctx = ensureAudioGraph();
...
function initializeAudioSystem() {
    ...
    settingsCleanup = (0, settings_1.subscribeToSettings)(() => {
        syncGainLevels();
    });
    const audioWindow = window;
...
function getCurrentMusicCue() {
    return currentMusicCue;
}
function playPlaceholderSfx(id) {
...
function playNamedAudioHook(id) {
...
function playSystemPingSfx(type) {
    if (type === "success") {
