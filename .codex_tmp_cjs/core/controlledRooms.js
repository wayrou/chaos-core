...
exports.recalculateDistancePenalties = recalculateDistancePenalties;
exports.processControlledRoomsTimeStep = processControlledRoomsTimeStep;
 ...
 */
function recalculateDistancePenalties(progress) {
 ...
 */
function processControlledRoomsTimeStep(reason, globalSupplyAvailable) {
    const progress = (0, campaign_1.loadCampaignProgress)();
    if (!progress.activeRun)
        return { progress, remainingSupply: globalSupplyAvailable };
    const activeRun = progress.activeRun;
    const currentFloor = activeRun.floorIndex;
