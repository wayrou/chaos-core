...
exports.FOUNDRY_PARTITION_DEFINITIONS = exports.FOUNDRY_MODULE_DEFINITIONS = exports.FOUNDRY_PARTITION_UNLOCK_ORDER = exports.FOUNDRY_MODULE_UNLOCK_ORDER = exports.ANNEX_FRAME_DEFINITIONS = void 0;
exports.getOrderedFoundryModuleTypes = getOrderedFoundryModuleTypes;
exports.getOrderedFoundryPartitionTypes = getOrderedFoundryPartitionTypes;
exports.createDefaultFoundryState = createDefaultFoundryState;
exports.normalizeFoundryUnlockState = normalizeFoundryUnlockState;
exports.withNormalizedFoundryState = withNormalizedFoundryState;
exports.getFoundryUnlockState = getFoundryUnlockState;
exports.isModuleTypeUnlocked = isModuleTypeUnlocked;
exports.isPartitionTypeUnlocked = isPartitionTypeUnlocked;
exports.unlockFoundryModuleTypeInState = unlockFoundryModuleTypeInState;
exports.unlockFoundryPartitionTypeInState = unlockFoundryPartitionTypeInState;
...
exports.ANNEX_FRAME_DEFINITIONS = {
    lightweight_annex: {
...
exports.FOUNDRY_MODULE_UNLOCK_ORDER = [
    "threat_sensor",
    "power_sensor",
    "bandwidth_sensor",
    "loom_terminal",
...
exports.FOUNDRY_PARTITION_UNLOCK_ORDER = [
    "blast_door",
];
exports.FOUNDRY_MODULE_DEFINITIONS = {
    threat_sensor: {
        id: "threat_sensor",
...
exports.FOUNDRY_PARTITION_DEFINITIONS = {
    blast_door: {
        id: "blast_door",
...
function getOrderedFoundryModuleTypes() {
    return [...exports.FOUNDRY_MODULE_UNLOCK_ORDER];
}
function getOrderedFoundryPartitionTypes() {
    return [...exports.FOUNDRY_PARTITION_UNLOCK_ORDER];
}
function createDefaultFoundryState() {
    return {
        unlockedModuleTypes: [],
        unlockedPartitionTypes: [],
    };
}
function normalizeFoundryUnlockState(foundry) {
    const moduleSet = new Set();
    (foundry?.unlockedModuleTypes ?? []).forEach((moduleType) => {
        if (exports.FOUNDRY_MODULE_UNLOCK_ORDER.includes(moduleType)) {
            moduleSet.add(moduleType);
        }
    });
    const partitionSet = new Set();
    (foundry?.unlockedPartitionTypes ?? []).forEach((partitionType) => {
        if (exports.FOUNDRY_PARTITION_UNLOCK_ORDER.includes(partitionType)) {
            partitionSet.add(partitionType);
        }
    });
    return {
        unlockedModuleTypes: exports.FOUNDRY_MODULE_UNLOCK_ORDER.filter((moduleType) => moduleSet.has(moduleType)),
        unlockedPartitionTypes: exports.FOUNDRY_PARTITION_UNLOCK_ORDER.filter((partitionType) => partitionSet.has(partitionType)),
    };
}
function withNormalizedFoundryState(state) {
...
function unlockFoundryPartitionTypeInState(state, partitionType) {
    const normalizedState = withNormalizedFoundryState(state);
    const definition = exports.FOUNDRY_PARTITION_DEFINITIONS[partitionType];
    if (!definition) {
