...
// ============================================================================
exports.THEMES = {
    ardycia: createTheme("ardycia", "Ardycia (Default)", "Warm earth tones with gold accents - the classic Chaos Core aesthetic", {
        white: "#fefefe",
        offWhite: "#ededec",
        silver: "#dcd7d9",
        mist: "#c1c3c4",
    ...
    cyberpunk: createTheme("cyberpunk", "Cyberpunk", "Neon blues and purples with high contrast - futuristic and vibrant", {
        white: "#ffffff",
        offWhite: "#e0e0ff",
        silver: "#b8b8ff",
        mist: "#9090cc",
    ...
    monochrome: createTheme("monochrome", "Monochrome", "Pure black and white with grayscale - minimalist and clean", {
        white: "#ffffff",
        offWhite: "#f0f0f0",
        silver: "#d0d0d0",
        mist: "#b0b0b0",
    ...
    warm: createTheme("warm", "Warm", "Rich oranges, reds, and browns - cozy and inviting", {
        white: "#fff8f0",
        offWhite: "#ffe8d0",
        silver: "#ffd8b0",
        mist: "#ffc890",
    ...
    cool: createTheme("cool", "Cool", "Blues, teals, and cool grays - calm and professional", {
        white: "#f0f8ff",
        offWhite: "#e0f0ff",
        silver: "#c0e0ff",
        mist: "#a0d0ff",
    ...
    // NEW THEMES
    neon: createTheme("neon", "Neon", "Electric pinks, purples, and cyans - high-energy and eye-catching", {
        white: "#ffffff",
        offWhite: "#ffe0ff",
        silver: "#ffb8ff",
        mist: "#cc90cc",
    ...
    forest: createTheme("forest", "Forest", "Deep greens and earth tones - natural and grounded", {
        white: "#f0fff0",
        offWhite: "#e0ffe0",
        silver: "#c0ffc0",
        mist: "#a0cca0",
    ...
    sunset: createTheme("sunset", "Sunset", "Vibrant oranges, pinks, and purples - dramatic and warm", {
        white: "#fff8f0",
        offWhite: "#ffe8e0",
        silver: "#ffd8c0",
        mist: "#ffc8a0",
    ...
    ocean: createTheme("ocean", "Ocean", "Deep blues and teals - serene and immersive", {
        white: "#f0f8ff",
        offWhite: "#e0f0ff",
        silver: "#c0e0ff",
        mist: "#a0d0ff",
    ...
    void: createTheme("void", "Void", "Deep purples and blacks with subtle glows - mysterious and dark", {
        white: "#f0f0ff",
        offWhite: "#e0e0ff",
        silver: "#c0c0ff",
        mist: "#a0a0cc",
...
function applyTheme(themeId) {
    const theme = exports.THEMES[themeId];
    if (!theme) {
    ...
    // Additional colors
    if (c.sage)
        root.style.setProperty("--ard-sage", c.sage);
    if (c.tan)
        root.style.setProperty("--ard-tan", c.tan);
    if (c.peach)
        root.style.setProperty("--ard-peach", c.peach);
    if (c.brownDark)
        root.style.setProperty("--ard-brown-dark", c.brownDark);
    if (c.brownMid)
        root.style.setProperty("--ard-brown-mid", c.brownMid);
    if (c.forest)
        root.style.setProperty("--ard-forest", c.forest);
    if (c.olive)
        root.style.setProperty("--ard-olive", c.olive);
    if (c.rose)
        root.style.setProperty("--ard-rose", c.rose);
    if (c.magenta)
        root.style.setProperty("--ard-magenta", c.magenta);
    if (c.cyan)
        root.style.setProperty("--ard-cyan", c.cyan);
    if (c.navy)
        root.style.setProperty("--ard-navy", c.navy);
    if (c.void)
        root.style.setProperty("--ard-void", c.void);
    // Backgrounds
...
function getTheme(themeId) {
    return exports.THEMES[themeId] || exports.THEMES.ardycia;
}
/**
 * Get all available themes
 */
function getAllThemes() {
    return Object.values(exports.THEMES);
}
