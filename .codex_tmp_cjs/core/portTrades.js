...
exports.RARE_RESOURCES = exports.BASIC_RESOURCES = void 0;
exports.getNormalTradeTemplates = getNormalTradeTemplates;
exports.getBulkShipmentBasicPayouts = getBulkShipmentBasicPayouts;
exports.getBulkShipmentInterestingPayouts = getBulkShipmentInterestingPayouts;
const resources_1 = require("./resources");
// ----------------------------------------------------------------------------
// BASIC RESOURCES
// ----------------------------------------------------------------------------
exports.BASIC_RESOURCES = [...resources_1.BASIC_RESOURCE_KEYS];
// Rare resources (only available for Bulk Shipment after Operation 4/5)
exports.RARE_RESOURCES = [...resources_1.ADVANCED_RESOURCE_KEYS];
// ----------------------------------------------------------------------------
...
// EXPORTS
// ----------------------------------------------------------------------------
function getNormalTradeTemplates() {
    return NORMAL_TRADE_TEMPLATES;
}
function getBulkShipmentBasicPayouts() {
    return BULK_SHIPMENT_BASIC_PAYOUTS;
}
function getBulkShipmentInterestingPayouts() {
