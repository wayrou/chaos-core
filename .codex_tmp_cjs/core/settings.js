...
exports.SETTING_DESCRIPTORS = exports.DEFAULT_SETTINGS = void 0;
...
// STATE
// ----------------------------------------------------------------------------
let currentSettings = { ...exports.DEFAULT_SETTINGS };
...
async function initializeSettings() {
    ...
    if (loaded) {
        currentSettings = { ...exports.DEFAULT_SETTINGS, ...loaded };
    }
    else {
        currentSettings = { ...exports.DEFAULT_SETTINGS };
    }
...
function getSettingsByCategory() {
    ...
    for (const desc of exports.SETTING_DESCRIPTORS) {
