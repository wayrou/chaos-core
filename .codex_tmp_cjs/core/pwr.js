...
exports.PWR_BANDS = void 0;
exports.calculatePWR = calculatePWR;
exports.getPWRBand = getPWRBand;
exports.getPWRBandColor = getPWRBandColor;
exports.updateUnitPWR = updateUnitPWR;
const classes_1 = require("./classes");
const equipment_1 = require("./equipment");
const equipment_2 = require("./equipment");
// ============================================================================
...
function calculatePWR(input) {
    ...
    const equip = equipmentById || (0, equipment_2.getAllStarterEquipment)();
    const equipStats = (0, equipment_1.calculateEquipmentStats)(loadout, equip);
    ...
    if (unitClassProgress) {
        const currentClass = (0, classes_1.getClassDefinition)(unitClassProgress.currentClass);
 ...
 */
function getPWRBandColor(pwr) {
    const band = getPWRBand(pwr);
    return exports.PWR_BANDS[band].color || "#888";
}
/**
 * Update PWR for a unit in game state
 * Call this whenever stats, gear, or class changes
 */
function updateUnitPWR(unitId, state, unitClassProgress) {
