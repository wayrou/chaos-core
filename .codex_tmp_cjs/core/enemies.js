...
exports.ENEMY_POOLS = exports.ENEMY_DATABASE = void 0;
exports.getCampaignRegionEnemyPool = getCampaignRegionEnemyPool;
exports.pickEnemyIdsForCampaignFloor = pickEnemyIdsForCampaignFloor;
...
function getCampaignRegionEnemyPool(floorOrdinal) {
...
function pickEnemyIdsForCampaignFloor(floorOrdinal, count, random = Math.random) {
...
function getEnemyDefinition(enemyId) {
    return exports.ENEMY_DATABASE[enemyId] || null;
}
/**
 * Get enemy pool for an operation
 */
function getEnemyPool(operationId) {
    ...
    return exports.ENEMY_POOLS[operationId] || exports.ENEMY_POOLS.op_custom;
}
