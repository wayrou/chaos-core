...
exports.createCompanion = createCompanion;
exports.updateCompanion = updateCompanion;
exports.updateCompanionFollow = updateCompanionFollow;
exports.updateCompanionFetch = updateCompanionFetch;
exports.updateCompanionAttack = updateCompanionAttack;
exports.findNearestResource = findNearestResource;
exports.findNearestEnemy = findNearestEnemy;
exports.checkCompanionReachedTarget = checkCompanionReachedTarget;
const outerDecks_1 = require("../core/outerDecks");
// ============================================================================
// CONSTANTS
// ============================================================================
...
function getCompanionTuning(map) {
    return (0, outerDecks_1.isOuterDeckAccessibleMap)(map.id) ? OUTER_DECK_COMPANION_TUNING : DEFAULT_COMPANION_TUNING;
}
// ============================================================================
// COMPANION CREATION
// ============================================================================
function createCompanion(startX, startY) {
    return {
        id: "sable",
        x: startX,
        y: startY,
...
function updateCompanion(companion, context) {
...
function updateCompanionFollow(companion, player, deltaTime, map) {
    const tuning = getCompanionTuning(map);
...
function updateCompanionFetch(companion, _player, target, deltaTime, map) {
    const tuning = getCompanionTuning(map);
    if (!target) {
...
function updateCompanionAttack(companion, _player, target, deltaTime, map) {
    const tuning = getCompanionTuning(map);
    if (!target) {
        // No target, return to follow
        return {
...
function findNearestResource(companion, _player, sparkles, map) {
...
function findNearestEnemy(companion, _player, enemies, map) {
...
// ============================================================================
function checkCompanionReachedTarget(companion, targetId, threshold = 30) {
