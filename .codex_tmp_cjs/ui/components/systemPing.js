...
exports.showSystemPing = showSystemPing;
const audioSystem_1 = require("../../core/audioSystem");
...
function showSystemPing(options) {
    const { type = "info", title, message, detail, durationMs = 2600, channel, replaceChannel = true, } = options;
    const stack = ensureSystemPingStack();
    (0, audioSystem_1.playSystemPingSfx)(type);
