...
export const BASE_CAMP_NODE_DEFINITIONS: BaseCampNodeDefinition[] = [
  ...
  { id: "loadout", label: "LOADOUT", objectId: "loadout_station", zoneId: "interact_loadout", width: 4, height: 2, defaultX: 52, defaultY: 9 },
  { id: "ops-terminal", label: "OPS TERMINAL", objectId: "ops_terminal", zoneId: "interact_ops", width: 8, height: 5, defaultX: 58, defaultY: 7 },
  { id: "quest-board", label: "QUEST BOARD", objectId: "quest_board", zoneId: "interact_quest_board", width: 4, height: 2, defaultX: 7, defaultY: 20 },
