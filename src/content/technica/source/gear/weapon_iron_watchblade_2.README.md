...
Runtime entry: `weapon_iron_watchblade_2.gear.json`
Content id: `weapon_iron_watchblade_2`
...
- `weapon_iron_watchblade_2.source.json` preserves the original Technica authoring document.
