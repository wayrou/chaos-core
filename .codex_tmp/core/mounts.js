 ...
 */
export function getMountById(mountId) {
 ...
 */
export function getStarterMounts() {
    return MOUNT_REGISTRY.filter(m => m.isStarterMount);
}
/**
 * Get mounts available for purchase (not starter, not already unlocked)
 */
export function getPurchasableMounts(stable) {
    return MOUNT_REGISTRY.filter(m => !m.isStarterMount && !stable.unlockedMountIds.includes(m.id));
}
// ----------------------------------------------------------------------------
 ...
 */
export function canUnitUseMount(unit, mount) {
 ...
 */
export function getCompatibleMounts(unit, stable) {
 ...
 */
export function createOwnedMount(mountId) {
 ...
 */
export function createInitialStableState() {
 ...
 */
export function unlockMount(stable, mountId) {
 ...
 */
export function assignMountToUnit(stable, mountInstanceId, unitId, unit) {
 ...
 */
export function unassignMountFromUnit(stable, unitId) {
    return {
        ...stable,
 ...
 */
export function unassignMount(stable, mountInstanceId) {
    return {
        ...stable,
        ownedMounts: stable.ownedMounts.map(m => {
            if (m.instanceId === mountInstanceId) {
 ...
 */
export function setAerissFieldMount(stable, mountInstanceId) {
...
export function getAerissFieldMount(stable) {
...
export function getAerissFieldMovementSpeedBonus(stable) {
 ...
 */
export function getMountStatModifiers(mountId) {
    const mount = getMountById(mountId);
    if (!mount) {
        return {};
    }
 ...
 */
export function getMountGrantedCards(mountId) {
    const mount = getMountById(mountId);
    if (!mount) {
 ...
 */
export function getMountPassiveTraits(mountId) {
    const mount = getMountById(mountId);
    if (!mount) {
        return [];
    }
 ...
 */
export function unitHasMountTrait(unit, stable, trait) {
 ...
 */
export function validateMountCards(cardIds) {
