...
export function computeGearBalanceScore(gear) {
...
export function getGearBalanceReference(slot) {
    return REFERENCE_BANDS[slot];
}
export function toBalanceableImportedGear(gear) {
    return {
        id: gear.id,
        name: gear.name,
        slot: gear.slot,
...
export function validateGearBalance(gear) {
