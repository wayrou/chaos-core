 ...
 */
export function getSupplyState(state) {
 ...
 */
export function updateSupplyState(state, updater) {
    const operation = getCurrentOperation(state);
    if (!operation)
        return;
 ...
 */
export function computeSupplyFlow(nodes, supplyState, profile) {
    const flowCache = {};
 ...
 */
export function computeSupplyHealth(flowCache, nodes) {
 ...
 */
export function rollLinkAttacks(supplyState, operationSeed, floorIndex, nodes) {
    const attacks = [];
 ...
 */
export function applyLinkAttack(supplyState, edgeId, damage) {
    const edgeState = supplyState.edgeState[edgeId] || { integrity: DEFAULT_EDGE_INTEGRITY };
 ...
 */
export function advanceSupplyStep(state) {
    const operation = getCurrentOperation(state);
    if (!operation)
        return;
    const floor = getCurrentFloor(operation);
