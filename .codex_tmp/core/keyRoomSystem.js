...
// ============================================================================
import { loadCampaignProgress, saveCampaignProgress, } from "./campaign";
 ...
 */
export function getKeyRoomsForFloor(floorIndex) {
 ...
 */
export function captureKeyRoom(nodeId, facility) {
 ...
 */
export function generateKeyRoomResources() {
    const progress = loadCampaignProgress();
    if (!progress.activeRun) {
        return progress;
    }
 ...
 */
export function applyKeyRoomPassiveEffects() {
    const activeRun = getActiveRun();
    if (!activeRun)
        return;
    const keyRoomsByFloor = activeRun.keyRoomsByFloor || {};
 ...
 */
export function rollKeyRoomAttack() {
    const progress = loadCampaignProgress();
    if (!progress.activeRun) {
        return null;
    }
 ...
 */
export function defendKeyRoom(keyRoomId) {
    const progress = loadCampaignProgress();
    if (!progress.activeRun) {
        throw new Error("No active run");
    }
 ...
 */
export function delayKeyRoomDefense(keyRoomId) {
    const progress = loadCampaignProgress();
    if (!progress.activeRun) {
        throw new Error("No active run");
    }
 ...
 */
export function abandonKeyRoom(keyRoomId) {
    const progress = loadCampaignProgress();
    if (!progress.activeRun) {
        throw new Error("No active run");
    }
 ...
 */
export function clearDefenseBattle(keyRoomId) {
    const progress = loadCampaignProgress();
    if (!progress.activeRun) {
        throw new Error("No active run");
    }
 ...
 */
export function grantFloorResources() {
    const progress = loadCampaignProgress();
    if (!progress.activeRun) {
        return progress;
    }
 ...
 */
export function getDefenseBattleTurns() {
