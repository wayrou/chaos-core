...
export function isRegisteredKeyItem(itemId) {
    return Boolean(getImportedKeyItem(itemId));
}
export function getOwnedKeyItemQuantity(state, itemId) {
...
export function getOwnedKeyItemIds(state) {
...
export function grantKeyItemToState(state, itemId, quantity = 1) {
    if (quantity <= 0) {
        return state;
    }
...
export function consumeKeyItemFromState(state, itemId, quantity = 1) {
    if (quantity <= 0) {
