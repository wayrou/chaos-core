...
// ============================================================================
import { createGrid, createBattleUnitState, calculateMaxUnitsPerSide } from "./battle";
 ...
 */
export function generateDefenseEncounter(floorIndex, encounterSeed) {
 ...
 */
export function createDefenseBattle(gameState, keyRoomId, turnsToSurvive, encounterSeed) {
    ...
    if (gameState.inventory) {
        const loadPenalties = computeLoadPenaltyFlags(gameState.inventory);
