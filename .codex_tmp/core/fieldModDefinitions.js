...
export const FIELD_MOD_DEFINITIONS = {
    // ============================================================================
    // COMMON - Unit Scope
    // ============================================================================
    mod_contact_damage: {
...
export function getAllFieldModDefs() {
    const imported = getAllImportedFieldMods().map((fieldMod) => ({
        id: fieldMod.id,
        name: fieldMod.name,
    ...
    const merged = new Map(Object.values(FIELD_MOD_DEFINITIONS).map((entry) => [entry.id, entry]));
    imported.forEach((entry) => merged.set(entry.id, entry));
    return Array.from(merged.values());
}
export function getFieldModDef(id) {
