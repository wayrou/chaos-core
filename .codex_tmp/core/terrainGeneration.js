...
export function generateElevationMap(width, height, maxElevation = 3, seed) {
    const elevations = [];
...
export function generateStructuredBoardLayout(width, height, seed, profile = "encounter") {
