...
export function getAtlasFloorMaps() {
...
export function getAtlasTheaterSummary(theaterId) {
...
export function getAtlasTheaterByOperationId(operationId) {
    if (!operationId) {
        return null;
    }
    for (const floor of ATLAS_FLOOR_MAPS) {
...
export function createAtlasOperation(theaterId) {
