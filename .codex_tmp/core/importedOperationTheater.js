...
export function getImportedOperationZoneName(operation) {
    return operation.zoneName?.trim() || operation.floors[0]?.name?.trim() || operation.codename;
}
export function getImportedOperationBriefing(operation) {
...
export function buildImportedOperationTheaterFloor(operation, floorIndex, options = {}) {
...
export function buildImportedOperationTheaterFloors(operation, options = {}) {
...
export function buildImportedOperationRuntime(operation, options = {}) {
    const briefing = getImportedOperationBriefing(operation);
    const currentFloorIndex = clampFloorIndex(operation, options.currentFloorIndex);
