 ...
 */
export function generateCover(tiles, gridWidth, gridHeight, battleSeed, reservedCells = []) {
 ...
 */
export function getCoverDamageReduction(tile) {
 ...
 */
export function getCoverVisualState(tile) {
 ...
 */
export function damageCover(tile, damage) {
    if (!tile.cover || tile.cover.hp <= 0) {
        return tile;
    }
