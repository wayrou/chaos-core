...
import { getStarterCardLibrary, } from "./gearWorkbench";
import { getAllStarterEquipment, getAllEquipmentCards, } from "./equipment";
import { getAllImportedGear, getAllImportedOperations, getAllImportedUnits, getImportedOperation, isTechnicaContentDisabled, } from "../content/technica";
...
export function createNewGameState() {
    ...
    const state = {
        ...
        cardLibrary: Object.fromEntries(Object.entries(getStarterCardLibrary()).filter(([cardId]) => !isTechnicaContentDisabled("card", cardId))),
