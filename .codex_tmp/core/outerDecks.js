...
export const OUTER_DECK_HAVEN_EXIT_SPAWN_TILE = { x: 24, y: 21, facing: "south" };
export const OUTER_DECK_OVERWORLD_ENTRY_SPAWN_TILE = { x: 70, y: 60, facing: "south" };
...
export function createDefaultOuterDecksState() {
    return {
...
export function getAllOuterDeckZoneDefinitions() {
    return OUTER_DECK_ZONE_ORDER.map((zoneId) => OUTER_DECK_ZONE_DEFINITIONS[zoneId]);
}
export function getOuterDeckZoneDefinition(zoneId) {
    return OUTER_DECK_ZONE_DEFINITIONS[zoneId];
}
export function getOuterDeckNpcEncounterDefinition(encounterId) {
    return OUTER_DECK_NPC_ENCOUNTERS[encounterId];
}
export function getOuterDeckCompletionReward(zoneId) {
    return getOuterDeckZoneDefinition(zoneId).completionReward;
}
export function getOuterDeckZoneLockedMessage(zoneId) {
    return getOuterDeckZoneDefinition(zoneId).lockedMessage;
}
export function getOuterDeckOverworldGateTile(zoneId) {
    return OUTER_DECK_OVERWORLD_BRANCH_SPAWNS[zoneId].gateTile;
}
export function getOuterDeckOverworldReturnSpawn(zoneId) {
    return OUTER_DECK_OVERWORLD_BRANCH_SPAWNS[zoneId].returnSpawn;
}
export function getOuterDeckZoneGateLabel(zoneId) {
    return getOuterDeckZoneDefinition(zoneId).gateLabel;
}
export function getOuterDeckBranchEntrySubarea(zoneId) {
    return getOuterDeckZoneDefinition(zoneId).subareas[0];
}
export function getUnlockedOuterDeckZoneIds(progress) {
...
export function isOuterDeckZoneUnlocked(zoneId, progress) {
    const highestReachedFloorOrdinal = Math.max(0, Number(progress?.highestReachedFloorOrdinal ?? 0));
    return highestReachedFloorOrdinal >= getOuterDeckZoneDefinition(zoneId).unlockFloorOrdinal;
}
export function isOuterDeckOverworldMap(mapId) {
    return String(mapId ?? "") === OUTER_DECK_OVERWORLD_MAP_ID;
}
export function isOuterDeckBranchMap(mapId) {
...
export function isOuterDeckAccessibleMap(mapId) {
    return isOuterDeckOverworldMap(mapId) || isOuterDeckBranchMap(mapId);
}
export function getOuterDeckFieldContext(mapId) {
...
export function getOuterDeckSubareaById(state, subareaId) {
...
export function getOuterDeckSubareaByMapId(state, mapId) {
...
export function setOuterDeckCurrentSubarea(state, targetSubareaId) {
    const outerDecks = getSafeOuterDecksState(state);
...
export function markOuterDeckSubareaCleared(state, subareaId) {
    const outerDecks = getSafeOuterDecksState(state);
    const expedition = cloneActiveExpedition(outerDecks.activeExpedition);
...
export function resolveOuterDeckMechanic(state, mechanicId) {
    const outerDecks = getSafeOuterDecksState(state);
    const expedition = cloneActiveExpedition(outerDecks.activeExpedition);
...
export function markOuterDeckCacheClaimed(state, cacheId) {
    const outerDecks = getSafeOuterDecksState(state);
    const expedition = cloneActiveExpedition(outerDecks.activeExpedition);
...
export function markOuterDeckNpcEncounterSeen(state, encounterId) {
    const outerDecks = getSafeOuterDecksState(state);
    const expedition = cloneActiveExpedition(outerDecks.activeExpedition);
...
export function claimOuterDeckCompletion(state, completedAt = Date.now()) {
    const outerDecks = getSafeOuterDecksState(state);
    const expedition = outerDecks.activeExpedition;
    if (!expedition) {
...
export function abortOuterDeckExpedition(state, endedAt = Date.now()) {
