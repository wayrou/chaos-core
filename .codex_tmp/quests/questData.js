...
// ============================================================================
import { getAllImportedQuests, getImportedQuest, isTechnicaContentDisabled, } from "../content/technica";
/**
...
export function getQuestById(questId) {
    return (getImportedQuest(questId) ||
        (isTechnicaContentDisabled("quest", questId) ? null : QUEST_DATABASE[questId]) ||
        null);
}
/**
